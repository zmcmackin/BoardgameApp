package com.teamfire.boardgameapp.config;
...
@Configuration
@EnableMongoRepositories("com.teamfire.boardgameapp.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.teamfire.boardgameapp.config.dbmigrations");
